...
( function ( $, data ) {
	...
	$( document ).on( 'click', '.cookiedk-modal-overlay', function ( e ) {
		if ( e.target === this ) {
	...
	$( document ).on( 'click', '.cookiedk-modal__close', function () {
	...
	// Rediger-knap klik.
	$( document ).on( 'click', '.cookiedk-edit-cookie', function ( e ) {
		e.preventDefault();
		var $btn = $( this );
		openEditModal( $btn.data( 'id' ), {
	...
	$( document ).on( 'submit', '#cookiedk-edit-form', function ( e ) {
		e.preventDefault();
		var $form = $( this );
	...
	$( document ).on( 'click', '.cookiedk-delete-cookie', function ( e ) {
		e.preventDefault();
	...
	$( document ).on( 'click', '#cookiedk-export-cookies', function ( e ) {
		e.preventDefault();
	...
	$( document ).on( 'click', '#cookiedk-save-settings-ajax', function ( e ) {
		e.preventDefault();
	...
	$( document ).on( 'click', '.cookiedk-table th[data-sortable]', function () {
		var $th     = $( this );
	...
	$( document ).on( 'click', '#cookiedk-reset-consent', function () {
		try {
